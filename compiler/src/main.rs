...
fn main() {
    let fm: Result<FileMap, std::io::Error> = FileMap::new("C:/Users/E.Barringer26/OneDrive - Bellarmine College Preparatory/Documents/GitHub/Compiler-in-Rust/compiler/src/hello.txt");
